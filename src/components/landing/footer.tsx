  ...
  return (
    <footer className="bg-transparent  lg:grid lg:grid-cols-5">
      ...
      <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8 ">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 text-black dark:text-white">
          <div>
            <p>
        ...
        <div className="mt-12 border-t border-gray-100 pt-12 text-black dark:text-white">
